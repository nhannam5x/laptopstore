...
public class BilldetailManagement extends javax.swing.JFrame {
    ...
    public BilldetailManagement() throws ClassNotFoundException {
        initComponents();
    ...
    {   
        ...
        for(Billdetail bd : billdls)
        {
            if(bd.getStatus() == 1){
                ...
                defaultModel.addRow(new Object[]{billID, quantity});
            }
        }
    }
    ...
    jlb_productID.setText("ProductID:");
    jPanel1.add(jlb_productID, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 138, 52));
    ...
    jPanel1.add(txt_productID, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 270, 190, 52));
...
//        a.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BilldetailManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new BilldetailManagement().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(BilldetailManagement.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }

...
public class AddDiscount extends javax.swing.JFrame {
    ...
    public void refeshText(){
        txt_discountID.setText("ProductID");
        txt_discountValue.setText("productName");
        txt_dateStart.setText("Category");
        txt_dateEnd.setText("DepartmentID");
    ...
    public void addDiscount(){
        ...
        System.out.println(isNumeric(txt_discountID.getText()));
        try {
            if(!isNumeric(txt_discountID.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Mã giảm không hợp lệ ", "Dialog",
            ...
            if(!isNumeric(txt_discountValue.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Phần trăm tiền giảm không hợp lệ ", "Dialog",
                JOptionPane.ERROR_MESSAGE);
                return;
            }
            ...
            String dateStart = txt_dateStart.getText();
            String dateEnd = txt_dateEnd.getText();
            int status = 1;
            ...
            if(!discountBUS.CheckDiscountID(discountID)) {
                        ...
                        JOptionPane.showMessageDialog(new JFrame(), "Mã giảm bị trùng", "Dialog",
                        JOptionPane.ERROR_MESSAGE);
                    }

...
public class CategoryManagement extends javax.swing.JFrame {
    ...
    private void showCategoryValue(ArrayList<Category> categoryls)
    {
        ...
        for(Category c : categoryls)
        {
            if (categoryBUS.CheckCategoryID(value))
            {
    ...
    private void delCategory(){
        ...
        try {    
         if(row < 0)
         {
           ...
           int status = 0;
           Category b = new Category(categoryID, categoryName, status);
           categoryBUS.SetCategory(b);
           refresh();
           resetText();
           row = -1;
    ...
    jPanel1.add(txt_categoryName, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 300, 200, 52));

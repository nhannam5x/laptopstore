...
public class AddStaff extends javax.swing.JFrame {
    ...
    public void addStaff(){
        ...
        try {
            ...
            if(!isNumeric(txt_authority.getText())){
                JOptionPane.showMessageDialog(new JFrame(), "Mã quyền không hợp lệ ", "Dialog",
                JOptionPane.ERROR_MESSAGE);
                return;
            }
            else authority = Integer.parseInt(txt_authority.getText());

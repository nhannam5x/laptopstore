...
public class BillManagement extends javax.swing.JFrame {
    ...
    private void showBillValue(ArrayList<Bill> billls)
    {
        ...
        jlb_customerID.setText(tbl_Bill.getModel().getValueAt(row, 2).toString());
        jlb_discountID.setText(tbl_Bill.getModel().getValueAt(row, 3).toString());
        jlb_totalPrice.setText(tbl_Bill.getModel().getValueAt(row, 4).toString());
        jlb_date.setText(tbl_Bill.getModel().getValueAt(row, 5).toString());
    ...
    jPanel1.add(jlb_staff, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 270, 60, 52));

    jlb_date.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jlb_date.setForeground(new java.awt.Color(255, 153, 51));
    jlb_date.setText("...");
    jPanel1.add(jlb_date, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 340, 90, 52));
    ...
    jPanel1.add(jlb_totalPrice1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 340, 110, 52));
    ...
    jlb_staffID.setText("...");
    jPanel1.add(jlb_staffID, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 270, 90, 52));

    jlb_totalPrice.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jlb_totalPrice.setForeground(new java.awt.Color(255, 153, 51));
    jlb_totalPrice.setText("...");
    jPanel1.add(jlb_totalPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 340, 90, 52));

    jlb_customerID.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jlb_customerID.setForeground(new java.awt.Color(255, 153, 51));
    jlb_customerID.setText("...");
    jPanel1.add(jlb_customerID, new org.netbeans.lib.awtextra.AbsoluteConstraints(960, 270, 90, 52));

 ...
 * @author LacKhaiMinh
 */
public class StaffRecovery extends javax.swing.JFrame {
    ...
    public StaffRecovery() {
            initComponents();
            
            
            
            tbl_Staff.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD, 12));
            tbl_Staff.getTableHeader().setOpaque(false);
            tbl_Staff.getTableHeader().setBackground(Color.orange);
            showTable();
    ...
    private void showTable()
    {
        try {
            ...
            Logger.getLogger(StaffRecovery.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void restoreStaff(){
        ...
        try {    
          if(row < 0)
         {
           JOptionPane.showMessageDialog(new JFrame(), "Chọn nhân viên cần khôi phục", "Dialog",
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Staff Recovery");

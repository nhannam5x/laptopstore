...
public class StaffManagement extends javax.swing.JFrame {
    ...
    int staffID;
    public static final int COLUMN_INDEX_staffID     = 0;
    ...
    public StaffManagement(int staffID) throws ClassNotFoundException {
        initComponents();
    ...
    {   
        ...
        for(Staff s : staffls)
        {
            if(s.getStatus() == 1){
                ...
                defaultModel.addRow(new Object[]{staffID, firstName, lastName, email, phone});
            }
        }
    }
    
    private void showStaffValue(ArrayList<Staff> staffls)
    {
    ...
    private void editStaff()
    {
        ...
        try {    
         if(row < 0)
         {
           JOptionPane.showMessageDialog(new JFrame(), "Chọn nhân viên cần sửa", "Dialog",
    ...
    try {    
      if(row < 0)
      {
        JOptionPane.showMessageDialog(new JFrame(), "Chọn nhân viên cần xoá", "Dialog",
        JOptionPane.ERROR_MESSAGE);
        return; 
      }
      ...
      int status = 0;
      Staff s = new Staff(staffID, firstName, lastName, email, phone, status);
      int response = JOptionPane.showConfirmDialog(this, "Bạn muốn xóa nhân viên "+ staffID +" không?", "confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE); 
      if(response == JOptionPane.YES_OPTION){
        staffBUS.SetStaff(s);
        refresh();
        resetText();
    ...
    public static void writeExcel(List<Staff> staff, String excelFilePath) throws IOException {
        // Create Workbook
    Workbook workbook = getWorkbook(excelFilePath);
 
        // Create sheet
    Sheet sheet = workbook.createSheet("Staff"); // Create sheet with sheet name
    ...
    private static void writeHeader(Sheet sheet, int rowIndex) {
        ...
        // Create cells
        Cell cell = row.createCell(COLUMN_INDEX_staffID);
    ...
    // Write data
    private static void writeBook(Staff staff, Row row) {
        ...
        Cell cell = row.createCell(COLUMN_INDEX_staffID);
        cell.setCellValue(staff.getStaffID());
    ...
    txt_sStaffID.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
    ...
    jPanel1.add(txt_sStaffID, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 440, 120, 52));

    jLabel5.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jLabel5.setForeground(new java.awt.Color(255, 153, 51));
    jLabel5.setText("Staff ID:");
    jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 440, 90, 52));

    jLabel6.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jLabel6.setForeground(new java.awt.Color(255, 153, 51));
    jLabel6.setText("Email:");
    jPanel1.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 530, 70, 52));
    ...
    jPanel1.add(txt_sEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 530, 250, 52));
    ...
    jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 440, 110, 52));
    ...
    jPanel1.add(txt_sFirstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 440, 260, 52));

    jLabel10.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jLabel10.setForeground(new java.awt.Color(255, 153, 51));
    jLabel10.setText("Last Name:");
    jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 440, 110, 52));
    ...
    jPanel1.add(txt_sLastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 440, 260, 52));

    jlb_staffID.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jlb_staffID.setForeground(new java.awt.Color(255, 153, 51));
    jlb_staffID.setText("...");
    jPanel1.add(jlb_staffID, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 270, 138, 52));
    ...
    jPanel1.add(jlb_firstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 270, 110, 52));
    ...
    jPanel1.add(txt_firstName, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 270, 260, 52));
    ...
    jPanel1.add(jlb_lastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 270, 110, 52));
    ...
    jPanel1.add(txt_lastName, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 270, 270, 52));
    ...
    jPanel1.add(jlb_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 340, 80, 52));
    ...
    jPanel1.add(txt_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 340, 250, 52));
    ...
    jPanel1.add(txt_phone, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 340, 260, 52));

    jlb_staff.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
    jlb_staff.setForeground(new java.awt.Color(255, 153, 51));
    jlb_staff.setText("Staff ID:");
    ...
    jPanel1.add(txt_sPhone, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 530, 260, 52));
    ...
    private void btn_restoreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_restoreActionPerformed
        StaffRecovery s = new StaffRecovery();
        s.setVisible(true);
...
//        AddCourse a = new AddCourse();
    ...
    private void btn_exportExcelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_exportExcelActionPerformed
        ...
        try {
            ...
            final String excelFilePath = "C:/Users/donha/Desktop/Staff_Excel_"+date+".xlsx";
            writeExcel(this.staffls,excelFilePath);

 ...
 * @author LacKhaiMinh
 */
public class CustomerRecovery extends javax.swing.JFrame {
    ...
    public CustomerRecovery() {
            initComponents();
            tbl_Customer.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD, 12));
            tbl_Customer.getTableHeader().setOpaque(false);
            tbl_Customer.getTableHeader().setBackground(Color.orange);
            showTable();
    }
    ...
    private void showTable()
    {
        try {
            ...
            Logger.getLogger(CustomerRecovery.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void restoreCustomer(){
        ...
        try {    
          if(row < 0)
         {
           JOptionPane.showMessageDialog(new JFrame(), "Chọn khách hàng cần khôi phục");
           return; 
         }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Customer Recovery");

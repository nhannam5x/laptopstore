...
public class SupplierManagement extends javax.swing.JFrame {
    ...
    private void showSupplierValue(ArrayList<Supplier> supplierls)
    {
        ...
        int value = (int) tbl_Supplier.getModel().getValueAt(row, 0);
        for(Supplier s : supplierls)
        {
            if (supplierBUS.CheckSupplierID(value))
            {
    ...
    jlb_supplierID.setText("...");
    jPanel1.add(jlb_supplierID, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 270, 138, 52));
    ...
    jlb_supplierName.setText("Supplier Name:");
    jPanel1.add(jlb_supplierName, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 270, 160, 52));
    ...
    jPanel1.add(txt_supplierName, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 270, 200, 52));
    ...
    jPanel1.add(jlb_address, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 270, 100, 52));
    ...
    jPanel1.add(txt_address, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 270, 200, 52));
    ...
    jPanel1.add(jlb_supplier, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 138, 52));

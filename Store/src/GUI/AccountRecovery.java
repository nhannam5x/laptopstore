...
public class AccountRecovery extends javax.swing.JFrame {
    ...
    public AccountRecovery() {
            initComponents();
            tbl_Account.getTableHeader().setFont(new Font("Segoe UI",Font.BOLD, 12));
            tbl_Account.getTableHeader().setOpaque(false);
            tbl_Account.getTableHeader().setBackground(Color.orange);
            showTable();
    }
    ...
    private void restoreCategory(){
        ...
        try {    
          if(row < 0)
         {
           JOptionPane.showMessageDialog(new JFrame(), "Chọn tài khoản cần khôi phục");
           return; 
         }
           ...
           Account a = new Account(accountID, accountName, password, staffID,status);
            ...
            if(accountBUS.CheckAccountID(accountID)){
                int response = JOptionPane.showConfirmDialog(this, "Bạn muốn khôi phục tài khoản nhân viên "+ staffID +" không?", "confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE); 
                ...
                JOptionPane.showMessageDialog(new JFrame(), "Tài khoản không có trong dữ liêu", "Dialog",
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Category Recovery");
        ...
        tbl_Account.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CategoryID", "Category Name","Password", "Staff ID"
            }
        )
        {
